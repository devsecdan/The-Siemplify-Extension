...
var AssignNewCases = (function () {
	...
	let caseListHeaderSelector = "cases-header-actions";
	let caseListActionGroupSelector = "cases-header-actions .smp-button-group";
	let refreshListButtonSelector = "button[smptooltip=\"Refresh\"]";

	var lastUsed = new Date(0);
	
	var enable = function () {
		ElementObserver.observe(caseListHeaderSelector, createButton);
		if (document.querySelector(caseListHeaderSelector)) {
