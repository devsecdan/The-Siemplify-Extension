...
var EntityEnrichment = (function () {
	...
	let entityContainerSelectors = ["entity-visualizer"];
	let entityValueSelector = "span";
	let environmentSelector = "environment-select";
    ...
    var enrichEntities = function(entity) {
		try {
			...
			let headerDescription = document.querySelector(environmentSelector);
			let environment = "";
			if (headerDescription) {
				environment = headerDescription.textContent.trim();
			}
